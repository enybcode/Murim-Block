package net.mcreator.murimblock;
...
@Mod("murim_block")
public class MurimBlockMod {
	public static final Logger LOGGER = LogManager.getLogger(MurimBlockMod.class);
	public static final String MODID = "murim_block";

	public MurimBlockMod(IEventBus modEventBus) {
